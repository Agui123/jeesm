...
function addToCartResponse(result)
{
  ...
  {
	var imgurl = $("#imgurl"+result.goods_id).val(); 
      ...
      switch(result.confirm_type)
      {
        case '1' :
        	if(typeof(arguments[3]) == "object"){
        		var dingdian = arguments[3];
        	}else{
        		var dingdian = "#f"+result.goods_id;
        	}
        	flyToCart(dingdian,".toplink",imgurl);
...
function flyToCart(obj, obj1, imgurl)
{
	var p1 = $(obj).offset();
	var p2 = $(obj1).offset();
